...
from bokeh.models.widgets import Panel, Tabs,TextInput,Button,Paragraph,Slider
...
def call_Sentimentplot(s):
    ...
    #adding glyph:
    f1=fig.line(x=a,y=pos,color='red',legend='Positive Sentiment Trend')
    f2=fig.line(x=a,y=neg,color='blue',legend='Negative Sentiment Trend')
    
    #Style the legend
    fig.legend.location = 'top_right'
    fig.legend.background_fill_alpha = 0.8
    fig.legend.border_line_color = None
    #fig.legend.add_rootmargin = 10
